                    ...
                    <div class="sb-sidenav-menu">
 			        ...
 			        <div class="sb-nav-link-icon"><i class="fas fa-tools"></i></div> Maintenance
                            ...
                            <a class="nav-link" href="peminjaman.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-hand-holding"></i></div> Peminjaman
                            </a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Edit Barang & Maintenance</h4>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                        </div>
                                                        <form method="post" enctype="multipart/form-data">
                                                            <div class="modal-body">
                                                                <small class="text-muted">Informasi Dasar</small>
                                                                <hr class="mt-0">
                                                                ...
                                                                <br>
                                                                <small class="text-muted">Update Kondisi & Maintenance</small>
                                                                <hr class="mt-0">
                                                                
                                                                <label class="small">Kondisi Barang:</label>
                                                                ...
                                                                <label class="small">Terakhir Di-Maintenance:</label>
                                                                <input type="date" name="tgl_maintenance" class="form-control mb-2" value="<?=$tgl_maintenance;?>">

                                                                <label class="small">Jadwal Service Selanjutnya:</label>
                                                                <input type="date" name="tgl_jadwal" class="form-control mb-3" value="<?=$tgl_jadwal;?>">
